    ...
    public static OptionPage silhouette() {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(boolean.class, silhouetteOptions)
                        ...
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, silhouetteOptions)
                        .setName(new TranslatableText(OptionsTranslatableTextMap.insaneDistance + ".name"))
                        .setTooltip(new TranslatableText(OptionsTranslatableTextMap.insaneDistance + ".tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.LOW)
                ...
                .add(OptionImpl.createBuilder(SilhouetteGamertagStyle.class, silhouetteOptions)
                        .setName(new TranslatableText(OptionsTranslatableTextMap.gamertagStyle + ".name"))
                        .setTooltip(new TranslatableText(OptionsTranslatableTextMap.gamertagStyle + ".tooltip"))
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(int.class, silhouetteOptions)
                        ...
                        .build())
                .add(OptionImpl.createBuilder(int.class, silhouetteOptions)
                        .setName(new TranslatableText(OptionsTranslatableTextMap.insaneDistanceGamertagSize + ".name"))
                        .setTooltip(new TranslatableText(OptionsTranslatableTextMap.insaneDistanceGamertagSize + ".tooltip"))
                        .setControl(option -> new SliderControl(option, 1, 20, 1, ControlValueFormatter.number()))
