...
import dev.lukel.silhouette.options.ui.binding.GenericBinding;
import dev.lukel.silhouette.options.ui.binding.OptionBinding;
...
public class OptionUiImpl<S, T> implements OptionUi<T> {
    ...
    private OptionUiImpl(OptionStorage<S> storage,
                         Text name,
                         Text tooltip,
                         OptionBinding<S, T> binding,
                         Function<OptionUiImpl<S, T>, Control<T>> control,
    ...
    public static <S, T> OptionUiImpl.Builder<S, T> createBuilder(Class<T> type, OptionStorage<S> storage) {
    ...
    public static class Builder<S, T> {
        ...
        private Function<OptionUiImpl<S, T>, Control<T>> control;
        ...
        public Builder<S, T> setControl(Function<OptionUiImpl<S, T>, Control<T>> control) {
        ...
        public OptionUiImpl<S, T> build() {
            ...
            return new OptionUiImpl<>(this.storage, this.name, this.tooltip, this.binding, this.control, this.flags, this.impact, this.enabled);
        }
    }
}