...
public class TickBoxControl implements Control<Boolean> {
    private final OptionUi<Boolean> option;

    public TickBoxControl(OptionUi<Boolean> option) {
        this.option = option;
    }
    ...
    @Override
    public OptionUi<Boolean> getOption() {
        return this.option;
    }
    ...
    private static class TickBoxControlElement extends ControlElement<Boolean> {
        ...
        public TickBoxControlElement(OptionUi<Boolean> option, Dim2i dim) {
            super(option, dim);
