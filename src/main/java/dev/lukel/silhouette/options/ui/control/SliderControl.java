...
public class SliderControl implements Control<Integer> {
    private final OptionUi<Integer> option;

    private final int min, max, interval;

    private final ControlValueFormatter mode;

    public SliderControl(OptionUi<Integer> option, int min, int max, int interval, ControlValueFormatter mode) {
    ...
    @Override
    public OptionUi<Integer> getOption() {
        return this.option;
    }
    ...
    private static class Button extends ControlElement<Integer> {
        ...
        public Button(OptionUi<Integer> option, Dim2i dim, int min, int max, int interval, ControlValueFormatter formatter) {
            super(option, dim);
